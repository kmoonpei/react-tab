...
export default class extends Component {
    ...
    render() {
        ...
        return (
            <div className={styles.contanier} style={this.contanierStyle}>
                <ul className={styles.tab_ul}>
                    {this.tabs.map((item, i) => {
                        return <li
                            key={i}
                            className={current_position == i ? `${styles.tab_li} ${styles.current}` : styles.tab_li}
                ...
                <div className={styles.content}>
                    <ul className={styles.content_ul}>
                        {currentList.map((item, i) => { return <li className={styles.item_li} key={i}>{item}</li> })}
                    </ul>
                </div>
            </div>
        )
